...
void main() {
    vec3 pos = vec3(fs_in.pos);

    vec3 color = vec3(1.0, 1.0, 0.0);
    float turbulence_value = turbulence(pos * 3.0) * 3.0;
    color = vec3(1.000,0.569,0.065) * pow(turbulence_value, 1.0) + vec3(0.5,0.5,0.0);

    //color = vec3(pow(turbulence_value, 2.0));
